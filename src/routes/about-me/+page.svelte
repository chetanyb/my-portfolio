...
<div class="w-full flex-col items-center justify-center">
	...
	<div class="flex-col">
		<h3 class="h3 bg-gradient-to-r from-yellow-400 to-yellow-700 px-4 py-1 text-orange-800">Experience</h3>
		<div class="m-2">
			<Accordion>
				<AccordionItem>
					...
					<svelte:fragment slot="content">
						<ul class="list-disc ml-6">
							<li>Going to be working on InfraPlatform for the biggest stock broker, with over 50 million users, in India</li>
						</ul>
					</svelte:fragment>
				</AccordionItem>
				<AccordionItem>
					...
					<svelte:fragment slot="content">
						<ul class="list-disc ml-6">
							<li>Developed a uniform job execution environment using Apptainer, an HPC specialized containerization engine, addressing
								varied GRID infrastructure and diverse job requirements</li>
							<li>Documented deployment procedures, ensuring consistent and efficient use of the GRID infrastructure</li>
						</ul>
					</svelte:fragment>
				</AccordionItem>
				<AccordionItem>
					...
					<svelte:fragment slot="content">
						<ul class="list-disc ml-6">
							...
							<li>Developed and optimized client efficiency by writing scripts to test multiple versions of execution and consensus clients
								simultaneously, reducing the time to identify faulty commits and versions</li>
							<li>Migrated encoding protocols to gogoproto standards while maintaining compatibility with older amino proto</li>
						</ul>
					</svelte:fragment>
				</AccordionItem>
			</Accordion>
	...
	<div class="flex-col">
		<h3 class="h3 bg-gradient-to-r from-yellow-400 to-yellow-700 px-4 py-1 text-orange-800">Education</h3>
		<div class="m-2">
			<Accordion>
				<AccordionItem>
					...
					<svelte:fragment slot="content">
						<ul class="list-disc ml-6">
							...
							<li>Dean's List for Academic Excellence Award: Recognised for outstanding academic performance during
								the academic year 2021-2022</li>
						</ul>
					</svelte:fragment>
				</AccordionItem>
				<AccordionItem>
	...
	<div class="flex-col">
		<h3 class="h3 bg-gradient-to-r from-yellow-400 to-yellow-700 px-4 py-1 text-orange-800">Skills and Tools</h3>
